...
from synbconvert.syn_notebook_handler import create_cell_metadata
from synbconvert.syn_notebook_handler import create_synapse_notebook_template
...
def append_text_as_cell_to_file(
    text: str, file: str, cell_type: str, hidden: bool = False
):
    cell: dict = {
        "cell_type": cell_type,
        "source": [e + "\n" for e in text.split("\n") if e],
