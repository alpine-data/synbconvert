...
class SynapseNotebookConverter(SynapseNotebookHandler, PythonFileHandler):
    ...
    def convert_synapse_notebook_to_python_file(self, notebook_file: str, python_file: str):
        cells = self.read_synapse_notebook(notebook_file)
        self.write_python_file(python_file, cells)
    
    def convert_python_file_to_synapse_notebook(self, python_file: str, notebook_file: str):
